...
graph_stacked_disaggregation: Ladesäuleninfrastruktur  ## uncomment this line for stacked bars. eplace 'Geschlecht' with the field of aggregation. 
computation_units: Anzahl [abs.] 
data_start_values:  # initialize the field to be shown  
 - field: Ladesäuleninfrastruktur
   value: Normalladepunkte (Enzkreis)
 - field: Ladesäuleninfrastruktur
   value: Schnellladepunkte (Enzkreis)

# 3. Berechnung und Quelle eingeben: 
national_geographical_coverage: Enzkreis
computation_definitions: 

SOURCE_TYPE: Bundesnetzagentur # data source  
